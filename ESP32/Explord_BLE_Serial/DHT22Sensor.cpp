...
void DHT22Sensor::printSerialHeader() {
  Serial.println(String(Humidity.getName()+","+Temp.getName()+","+Dew.getName()+","+Heat.getName()));
}

void DHT22Sensor::printSerialData() {
  Serial.println(String(Humidity.getSValue()+","+Temp.getSValue()+","+Dew.getSValue()+","+Heat.getSValue()));
}
